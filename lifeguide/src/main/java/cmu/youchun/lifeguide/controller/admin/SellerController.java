...
import cmu.youchun.lifeguide.form.SellerForm;
...
public class SellerController {
    ...
    @AdminPermission
    public String create(@Valid SellerForm sellerForm, BindingResult bindingResult) throws BusinessException {
    ...
    public CommonRes down(@RequestParam(value="id")Integer id) throws BusinessException {
        SellerModel sellerModel = sellerService.changeStatus(id);
