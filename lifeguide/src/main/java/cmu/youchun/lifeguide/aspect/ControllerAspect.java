package cmu.youchun.lifeguide.aspect;

import cmu.youchun.lifeguide.common.CommonError;
import cmu.youchun.lifeguide.common.CommonRes;
import cmu.youchun.lifeguide.common.EmBusinessError;
import cmu.youchun.lifeguide.controller.admin.AdminController;
...
public class ControllerAspect {
    ...
    @Around("execution(* cmu.youchun.lifeguide.controller.admin*.*(..)) && @annotation(org.springframework.web.bind.annotation.RequestMapping)")
