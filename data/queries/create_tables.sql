...
CREATE TABLE lifeguidedb.`seller`  (
                                        `id` int(0) NOT NULL AUTO_INCREMENT,
                                        `name` varchar(80) NOT NULL DEFAULT '',
                                        `created_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
                                        `updated_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE lifeguidedb.`category`  (
                                          `id` int(0) NOT NULL AUTO_INCREMENT,
                                          `created_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
                                          `updated_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE lifeguidedb.`recommend`  (
                                      `user_id` int(0) NOT NULL,
                                      `shop_id_list` varchar(255) NOT NULL DEFAULT '',
                                      PRIMARY KEY (`user_id`)
);